...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/matrixstyle.css" />
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <a href="" target="_blank"><?php echo date('Y'); ?> &copy; RR SI - Ronaldo & Ricardo </a></div>
</div>
<!--end-Footer-part-->
